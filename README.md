...
[![Hex.pm](https://img.shields.io/badge/hex-3.0.0--beta.3-714a96.svg)](https://hex.pm/packages/jido_signal)
[![Hex Docs](https://img.shields.io/badge/hex-docs-lightgreen.svg)](https://hexdocs.pm/jido_signal/3.0.0-beta.3/)
...
Version 3.0.0-beta.3 is a public beta. The v3 API can change before the stable
...
[API reference](https://hexdocs.pm/jido_signal/3.0.0-beta.3/).
...
- [Hex Package](https://hex.pm/packages/jido_signal/3.0.0-beta.3)
- [Documentation](https://hexdocs.pm/jido_signal/3.0.0-beta.3/)
